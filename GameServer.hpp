...
public:
	...
	~GameServer();
	void NotifyPlayerSpawn(sf::Int32 tank_identifier);
	void NotifyPlayerRealtimeChange(sf::Int32 tank_identifier, sf::Int32 action, bool action_enabled);
	void NotifyPlayerEvent(sf::Int32 tank_identifier, sf::Int32 action);
